...
- macroplot:
  ...
  with subplot radius of 24 ft (7.3152 m). See
  [`create_fia_owin()`](https://ctoney.github.io/FIAstemmap/reference/create_fia_owin.md).
  By default, "macroplot trees" having `DIST` outside the subplot
...
with functions of the spatstat library.
